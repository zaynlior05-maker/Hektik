...
LEADS = {
    # Custom Non-Country Categories (Integrated seamlessly into the Leads menu)
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("lc|"):
        ...
        await query.edit_message_text(
            ...
            f"*Stock:* {total:,} available\n\n"
            f"Select sub-category:",
    ...
    if data.startswith("lb|"):
        ...
        await query.edit_message_text(
            ...
            f"💷 Paid: *£{price}*\n"
            f"💰 Remaining: *£{user_balances[uid]:.2f}*\n\n"
            f"Contact @{SUPER_ADMIN} to receive your order.",
